public class StudentScoreManagement {
    public static void main(String[] args) {
        ...
        students[0] = new Student("Ramesh", 98);
        students[1] = new Student("Kamlesh", 88);
        students[2] = new Student("surest", 90);
        students[3] = new Student("ram", 95);
        students[4] = new Student("Ankit", 89);
        students[5] = new Student("harsh", 91);
        students[6] = new Student("lavish", 87);
        students[7] = new Student("Hartree", 93);
        students[8] = new Student("Kamlesh", 85);
        students[9] = new Student("jaunty", 94);
